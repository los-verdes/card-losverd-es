...
describe("buildGoogleWalletSaveUrl", () => {
  ...
  it("builds a signed save link for the member, with a verifiable QR URL", async () => {
    await insertMember();
