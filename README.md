...
- [`docs/membership-card-provenance.md`](docs/membership-card-provenance.md): where each card field comes from and how "current member" is decided, written for the Merch Team
